...
if (svg) {
  const paths = [
    ...
    { el: 'dot2', path: [{x:10,y:112},{x:60,y:112},{x:110,y:112},{x:150,y:111},{x:170,y:110}] },
    { el: 'dot3', path: [{x:10,y:172},{x:60,y:172},{x:110,y:172},{x:150,y:143},{x:170,y:115}] },
    { el: 'dot4', path: [{x:275,y:111},{x:302,y:111},{x:330,y:111}] },
    { el: 'dot5', path: [{x:380,y:144},{x:380,y:190},{x:330,y:190},{x:275,y:190},{x:165,y:190}] },
    { el: 'dot6', path: [{x:380,y:144},{x:380,y:270},{x:330,y:270},{x:275,y:270},{x:165,y:270}] },
    { el: 'dot7', path: [{x:380,y:144},{x:380,y:350},{x:330,y:350},{x:275,y:350},{x:165,y:350}] },
  ];
